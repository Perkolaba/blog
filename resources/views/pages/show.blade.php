            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="top-comment"><!--top comment-->
                        <img src="{{$post->author->getAvatar()}}" class="pull-left img-circle" alt="" height="109" width="109">
                    ...
                    <div class="related-post-carousel"><!--related post carousel-->
                        ...
                        <div class="comment-img">
                                <img class="img-circle" src="{{$comment->author->getAvatar()}}" alt="" height="86" width="86">
                        </div>
